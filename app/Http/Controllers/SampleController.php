    ...
    public function index(Request  $request)
    {
        ...
        if($request->ajax())
        {
            ...
            ->addColumn('action', function($data)
            {
                ...
                {
                    $checkBox = '<input type="checkbox" name="checkBox" class="checkbox form-check-input" id="checkBoxes" value="'.$data->id.'" data-id="'.$data->id.'"/>';
                    return $checkBox;
                })
...
//                ->addColumn('checkbox', function($data)
//                {
//                    $checkBox = '<input type="checkbox" name="id[]" id="'.$data->id.'" class="checkbox"></input>';
//                    return $checkBox;
//                })
//                ->rawColumns(['checkbox'])
//                ->make(true);
...
//        echo $student_id_array;
        $student = Sample_data::whereIn('id', $student_id_array);
        if($student->delete())
        {
            echo 'Data Deleted';
        }
